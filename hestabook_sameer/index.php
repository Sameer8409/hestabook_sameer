...
<div class="container">
        ...
        <input type="submit" name="loginsubmit" id="login-submit" tabindex="4" class="form-control btn btn-login" value="Log In" onsubmit="validateEmail()">
                                            </div>
                                        </div>
                                    </div>
                                    <!--<div class="form-group">
            ...
            <input type="text" name="name" id="name" class="form-control" placeholder="name" required>
                                    ...
                                    <div class="form-group">
            <input type="email" name="email" id="email" class="form-control" placeholder="email" value="" required  onchange="validateEmail();">
                                    </div>
                                    <div class="form-group">
                <input type="password" name="password" class="form-control" placeholder="password (min 6 character)" minlength="6" required>
                                    </div>                                    
                ...
                <input type="address" name="addr" id="address" class="form-control" placeholder="address" required>
                                ...
                                <div class="form-group">
                <input type="tel" pattern="^\d{10}$" name="mobile" id="number" class="form-control" placeholder="Mobile No." required>
                                    </div>
                                    <div class="form-group">
  ...
  <input type="radio" name="gender" value="other"> Other
            ...
            <!--<input type="radio" name="gender" id="gender-0" tabindex="1" class="form-control" placeholder="Select your gender" value="">-->
                                     </div>
                                      <div class="form-group">
            ...
            <input type="file" name="image" id="gender-0" tabindex="1" class="form-control">
                                    ...
                                    <!-- <div class="form-group">
            <input type="file" name="file_img" id="gender-0" tabindex="1" class="form-control" class="form-control">
                                     </div> -->
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-6 col-sm-offset-3">
<input type="submit" name="btn_upload" id="SignUp-submit" tabindex="4" class="form-control btn btn-SignUp" value="SignUp Now" onsubmit="validateEmail()">
                                            </div>
                                        </div>
                                    </div>
                                </form>
