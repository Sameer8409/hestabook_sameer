...
$sql = "INSERT INTO user (name, email,mobile,password,gender,dob,address,description,picture) VALUES ('$name', '$email',$mobile,'$password','$gender','$dob','$address','$descr','$file_path');";
		...
		{
      $a="<script>alert('Registration successful!  Please login with your email id and password!'); window.location = 'index.php';</script>";
      echo $a;
	 ...
	 {
    $a="<script>alert('Please fill the all details'); window.location = 'index.php';</script>";
      echo $a;
